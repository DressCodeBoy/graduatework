...
class __TwigTemplate_bbcc5cc62467a1e5a8dc15a4be487c16 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <form method=\"post\" action=\"";
        ...
        if ((twig_length_filter($this->env, ($context["selected"] ?? null)) == 1)) {
            // line 11
            echo "                    ";
            echo twig_escape_filter($this->env, twig_sprintf(_gettext("Create version %1\$s of %2\$s"), (            // line 12
...
";
    ...
    {
        return new Source("", "create_tracking_version.twig", "C:\\Server\\data\\htdocs\\phpmyadmin\\templates\\create_tracking_version.twig");
    }
}
